...
export const About = () => {
    ...
    return (
        <div id="about" className={styles.about}>
            <div
                className={`${styles.row} ${styles.topRow} ${visible ? styles.in : ""}`}
            >
                <p className={`${styles.Fredoka} ${styles.fromLeft}`}>
                ...
                <div className={`${styles.flipCard} ${styles.fromRight}`}>
            ...
            <div
                className={`${styles.row} ${styles.bottomRow} ${visible ? styles.inDelayed : ""
                    }`}
            >
                <div className={`${styles.flipCard} ${styles.fromLeft}`}>
                    <div className={styles.flipInner}>
                        <img src={AboutDuck3} alt="Duck 3" className={styles.flipFront} />
                        <img src={AboutDuck4} alt="Duck 4" className={styles.flipBack} />
                    </div>
                </div>
                <p className={`${styles.Fredoka} ${styles.fromRight}`}>
